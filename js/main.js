...
var AfterDeathRestartGameTransitionState, AfterLevelCompletedTransitionState, Game, GameOverScreenState, GameStartTransitionState, GameState, PlayState, TitleScreenState, _ref, _ref1, _ref2, _ref3, _ref4, _ref5,
...
GameStartTransitionState = (function(_super) {
  ...
  function GameStartTransitionState() {
    _ref1 = GameStartTransitionState.__super__.constructor.apply(this, arguments);
    return _ref1;
  }
...
AfterDeathRestartGameTransitionState = (function(_super) {
  ...
  function AfterDeathRestartGameTransitionState() {
    _ref2 = AfterDeathRestartGameTransitionState.__super__.constructor.apply(this, arguments);
    return _ref2;
  }
  ...
  AfterDeathRestartGameTransitionState.prototype.create = function(args) {
    ...
    if (this.args.next === 'next-life') {
      ...
      return window.soundManager.play('no-oo.wav');
    }
  };
...
AfterLevelCompletedTransitionState = (function(_super) {
  ...
  function AfterLevelCompletedTransitionState() {
    _ref3 = AfterLevelCompletedTransitionState.__super__.constructor.apply(this, arguments);
    return _ref3;
  }
...
PlayState = (function(_super) {
  ...
  function PlayState() {
    _ref4 = PlayState.__super__.constructor.apply(this, arguments);
    return _ref4;
  }
...
GameOverScreenState = (function(_super) {
  ...
  function GameOverScreenState() {
    _ref5 = GameOverScreenState.__super__.constructor.apply(this, arguments);
    return _ref5;
  }
