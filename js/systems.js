...
var AcornSystem, AnimatedSpriteSystem, AnimationDirectionSyncSystem, CameraFollowingSystem, DialogRenderingSystem, EyeFollowingSystem, GridMovementSystem, InputSystem, MovementSystem, RandomInputSystem, ShapeRenderSystem, StaticSpriteRenderSystem, System, TilemapRenderingSystem, TweenSystem, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
...
GridMovementSystem = (function(_super) {
  ...
  GridMovementSystem.prototype.update = function(delta) {
    var canMove, collisionLayer, direction, dx, dy, entity, gridPosition, input, movement, newCol, newRow, nextTile, otherGridPosition, pixelPosition, tileIdx, tween, tweens, _, _i, _j, _len, _len1, _ref1, _ref2, _results;
...
CameraFollowingSystem = (function(_super) {
  ...
  CameraFollowingSystem.prototype.update = function(delta) {
    var camera, cameraPosition, followee, followeePosition, mapHeight, mapLayer, mapLayerComponent, mapWidth, targetX, targetY, _, _ref7, _ref8, _ref9;
    ...
    _ref9 = this.entityManager.getFirstEntityAndComponents(['TilemapVisibleLayerComponent']), mapLayer = _ref9[0], mapLayerComponent = _ref9[1];
...
AnimationDirectionSyncSystem = (function(_super) {
  ...
  AnimationDirectionSyncSystem.prototype.update = function(delta) {
    var animation, animationEntity, direction, movement, _i, _len, _ref10, _ref11, _results;
    _ref10 = this.entityManager.iterateEntitiesAndComponents(['AnimationComponent', 'DirectionComponent', 'GridMovementComponent']);
    _results = [];
    for (_i = 0, _len = _ref10.length; _i < _len; _i++) {
      _ref11 = _ref10[_i], animationEntity = _ref11[0], animation = _ref11[1], direction = _ref11[2], movement = _ref11[3];
      if (movement.isMoving) {
...
StaticSpriteRenderSystem = (function(_super) {
  ...
  function StaticSpriteRenderSystem() {
    _ref11 = StaticSpriteRenderSystem.__super__.constructor.apply(this, arguments);
    return _ref11;
  }

  StaticSpriteRenderSystem.prototype.draw = function() {
    var camera, cameraPosition, position, screenX, screenY, sprite, spriteEntity, _, _i, _len, _ref12, _ref13, _ref14, _results;
    _ref12 = this.entityManager.getFirstEntityAndComponents(['CameraComponent', 'PixelPositionComponent']), camera = _ref12[0], _ = _ref12[1], cameraPosition = _ref12[2];
    _ref13 = this.entityManager.iterateEntitiesAndComponents(['StaticSpriteComponent', 'PixelPositionComponent']);
    _results = [];
    for (_i = 0, _len = _ref13.length; _i < _len; _i++) {
      _ref14 = _ref13[_i], spriteEntity = _ref14[0], sprite = _ref14[1], position = _ref14[2];
...
EyeFollowingSystem = (function(_super) {
  ...
  function EyeFollowingSystem() {
    _ref12 = EyeFollowingSystem.__super__.constructor.apply(this, arguments);
    return _ref12;
  }

  EyeFollowingSystem.prototype.draw = function() {
    var camera, cameraPosition, dist, drawX, drawY, dx, dy, eyeEntity, eyeHaverPosition, eyes, offsetX, offsetY, targetPosition, unitX, unitY, _, _i, _len, _ref13, _ref14, _ref15, _results;
    _ref13 = this.entityManager.getFirstEntityAndComponents(['CameraComponent', 'PixelPositionComponent']), camera = _ref13[0], _ = _ref13[1], cameraPosition = _ref13[2];
    _ref14 = this.entityManager.iterateEntitiesAndComponents(['EyeHavingComponent', 'PixelPositionComponent']);
    _results = [];
    for (_i = 0, _len = _ref14.length; _i < _len; _i++) {
      _ref15 = _ref14[_i], eyeEntity = _ref15[0], eyes = _ref15[1], eyeHaverPosition = _ref15[2];
...
AcornSystem = (function(_super) {
  ...
  function AcornSystem() {
    _ref13 = AcornSystem.__super__.constructor.apply(this, arguments);
    return _ref13;
  }

  AcornSystem.prototype.update = function(delta) {
    var acorn, acornEntity, acornPosition, acornsLeft, player, playerPosition, score, scoreEntity, _, _i, _len, _ref14, _ref15, _ref16, _ref17, _results;
    _ref14 = this.entityManager.getFirstEntityAndComponents(['PlayerComponent', 'GridPositionComponent']), player = _ref14[0], _ = _ref14[1], playerPosition = _ref14[2];
    _ref15 = this.entityManager.getFirstEntityAndComponents(['ScoreComponent', 'AcornsLeftComponent']), scoreEntity = _ref15[0], score = _ref15[1], acornsLeft = _ref15[2];
    _ref16 = this.entityManager.iterateEntitiesAndComponents(['AcornComponent', 'GridPositionComponent']);
    _results = [];
    for (_i = 0, _len = _ref16.length; _i < _len; _i++) {
      _ref17 = _ref16[_i], acornEntity = _ref17[0], acorn = _ref17[1], acornPosition = _ref17[2];
