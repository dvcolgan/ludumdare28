...
var AcornSystem, AnimatedSpriteSystem, AnimationDirectionSyncSystem, AstarInputSystem, CameraFollowingSystem, DialogRenderingSystem, EnemyDamageSystem, EyeFollowingSystem, FireSpreadingSystem, GridMovementSystem, InputSystem, LevelLoaderSystem, MovementSystem, MultiStateStaticSpriteRenderSystem, RandomInputSystem, ScoreRenderingSystem, ShapeRenderSystem, StaticSpriteRenderSystem, System, TilemapRenderingSystem, TweenSystem, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
...
EnemyDamageSystem = (function(_super) {
  ...
  function EnemyDamageSystem() {
    _ref17 = EnemyDamageSystem.__super__.constructor.apply(this, arguments);
    return _ref17;
  }

  EnemyDamageSystem.prototype.update = function(delta) {
    var enemy, enemyPosition, lives, player, playerPixelPosition, playerPosition, score, scoreEntity, __, _i, _len, _ref18, _ref19, _ref20, _ref21, _results;
    _ref18 = this.entityManager.getFirstEntityAndComponents(['PlayerComponent', 'GridPositionComponent', 'PixelPositionComponent']), player = _ref18[0], __ = _ref18[1], playerPosition = _ref18[2], playerPixelPosition = _ref18[3];
    _ref19 = this.entityManager.iterateEntitiesAndComponents(['EnemyComponent', 'GridPositionComponent']);
    _results = [];
    for (_i = 0, _len = _ref19.length; _i < _len; _i++) {
      _ref20 = _ref19[_i], enemy = _ref20[0], __ = _ref20[1], enemyPosition = _ref20[2];
      if (enemyPosition.col === playerPosition.col && enemyPosition.row === playerPosition.row) {
        ...
        if (lives.lives > 0) {
          ...
          _results.push(enemyPosition.justEntered = true);
        } else {
          _results.push(game.pushState(GameOverScreenState, {
...
FireSpreadingSystem = (function(_super) {
  ...
  function FireSpreadingSystem() {
    _ref18 = FireSpreadingSystem.__super__.constructor.apply(this, arguments);
    return _ref18;
  }

  FireSpreadingSystem.prototype.update = function(delta) {
    var acorn, acornEntity, acornPosition, direction, doSpread, fire, firePosition, newCol, newFireEnemy, newRow, otherFirePosition, spreading, __, _i, _j, _k, _len, _len1, _len2, _ref19, _ref20, _ref21, _ref22, _ref23, _ref24, _results;
    _ref19 = this.entityManager.iterateEntitiesAndComponents(['SpreadingFireComponent', 'GridPositionComponent']);
    _results = [];
    for (_i = 0, _len = _ref19.length; _i < _len; _i++) {
      _ref20 = _ref19[_i], fire = _ref20[0], spreading = _ref20[1], firePosition = _ref20[2];
      ...
      if (spreading.eventTimer >= spreading.interval) {
        ...
        if (Math.random() < spreading.chance) {
          _ref21 = this.entityManager.iterateEntitiesAndComponents(['AcornComponent', 'GridPositionComponent']);
          ...
          doSpread = true;
          _ref23 = this.entityManager.iterateEntitiesAndComponents(['SpreadingFireComponent', 'GridPositionComponent']);
          for (_k = 0, _len2 = _ref23.length; _k < _len2; _k++) {
            _ref24 = _ref23[_k], __ = _ref24[0], __ = _ref24[1], otherFirePosition = _ref24[2];
          ...
          _results.push((function() {
            var _l, _len3, _ref25, _ref26, _results1;
            _ref25 = this.entityManager.iterateEntitiesAndComponents(['AcornComponent', 'GridPositionComponent']);
            _results1 = [];
            for (_l = 0, _len3 = _ref25.length; _l < _len3; _l++) {
              _ref26 = _ref25[_l], acornEntity = _ref26[0], acorn = _ref26[1], acornPosition = _ref26[2];
              if (acornPosition.col === firePosition.col && acornPosition.row === firePosition.row) {
...
LevelLoaderSystem = (function(_super) {
  ...
  function LevelLoaderSystem(cq, entityManager, eventManager, assetManager) {
    var player, __, _ref19,
      _this = this;
    this.cq = cq;
    this.entityManager = entityManager;
    this.eventManager = eventManager;
    this.assetManager = assetManager;
    _ref19 = this.entityManager.getFirstEntityAndComponents(['PlayerComponent']), player = _ref19[0], __ = _ref19[1];
    this.eventManager.subscribe('next-level', player, function() {
      var level, levelIdx, _ref20;
      _ref20 = _this.entityManager.getFirstEntityAndComponents(['CurrentLevelComponent']), __ = _ref20[0], level = _ref20[1];
      level.level++;
      levelIdx = ((level.level - 1) % 3) + 1;
      return _this.loadLevel('level' + levelIdx + '.json');
    });
  }
  ...
  LevelLoaderSystem.prototype.loadLevel = function(tileDataUrl, speedFactor) {
    ...
    for (_i = 0, _len = _ref19.length; _i < _len; _i++) {
      _ref20 = _ref19[_i], enemyEntity = _ref20[0], __ = _ref20[1];
      oldEntities.push(enemyEntity);
    }
    _ref21 = this.entityManager.iterateEntitiesAndComponents(['TilemapVisibleLayerComponent']);
    for (_j = 0, _len1 = _ref21.length; _j < _len1; _j++) {
      _ref22 = _ref21[_j], layerEntity = _ref22[0], __ = _ref22[1];
      oldEntities.push(layerEntity);
    }
    _ref23 = this.entityManager.iterateEntitiesAndComponents(['TilemapCollisionLayerComponent']);
    for (_k = 0, _len2 = _ref23.length; _k < _len2; _k++) {
      _ref24 = _ref23[_k], collisionEntity = _ref24[0], __ = _ref24[1];
    ...
    _ref25 = this.entityManager.getFirstEntityAndComponents(['PlayerComponent', 'PixelPositionComponent', 'GridPositionComponent']), player = _ref25[0], __ = _ref25[1], playerPixelPosition = _ref25[2], playerGridPosition = _ref25[3];
